...
and chi_tiet_gio_hang.id_mon_an=mon_an.id_mon_an  and gio_hang.id_gio_hang='" . $key . "'";
    $phieu = mysqli_query($mysqli, $sql_phieu);

    $sql_hd = "SELECT * FROM hoa_don,gio_hang,khach_hang
where khach_hang.id_kh= gio_hang.id_kh and hoa_don.id_gio_hang=gio_hang.id_gio_hang AND hoa_don.id_gio_hang='" . $key . "'";
